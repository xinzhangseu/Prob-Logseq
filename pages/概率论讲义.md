...
Borel 从未尝试将他的测度理念应用于积分问题。事实上，他甚至说过：“将我们所给出的定义与M. Jordan 在其《解析课程》中给出的更一般的定义进行比较是有益的。”此处我们研究的问题与M. Jordan 解决的问题完全不同。“Borel 测度实际上适用于比 Jordan 测度集合更小的集合族。鉴于我们以 Borel 意义下可测量而非 Jordan 内容时得到了一些例子，这可能听起来很奇怪。”
