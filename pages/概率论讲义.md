...
在我们讨论约旦测度之前，我们先讨论更简单的基本测度概念，它允许我们测量一类非常简单的集合，即基本集合（有限个盒子的并）。
...
> [!math|{"type":"proposition","number":"auto","setAsNoteMathLink":false,"label":"jordan-measure-property","_index":2}] 命题 3.
