...
**基数(势)**  [Page 72](http://xzhang.ink:8083/read/4314/pdf)
基数(势)由康托尔于1874年－1884年在最原始的集合论（现称朴素集合论）中首次引入。基数(势)是最朴素的集合大小度量工具，但其严格定义过于复杂。因此，我们并不打算对基数进行正式定义，那会让我们离题太远。非正式地说，它是每个集合都具有的一种属性，并且在某种意义上衡量了集合的大小。对于我们的目的来说，重要的是如何判定两个集合基数的大小。
...
> [!math|{"type":"example","number":"auto","setAsNoteMathLink":false,"label":"nnum","_index":2}] 例 3.
