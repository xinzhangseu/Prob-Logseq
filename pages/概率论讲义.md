...
> 1. 称 $I$ 是 $\mathbb$ 一个区间, 如果它是 $\mathbb{R}$ 的子集, 且其形式为 $[a,  b]:=\{x \in \mathbb{R}: a \leq x \leq b\}, [a,  b):=\{x \in \mathbb{R}: a \leq x<b\}, (a,  b]:=\{x \in \mathbb{R}: a<x \leq b\}$, 或者 $(a,  b):=\{x \in \mathbb{R}:$ $a<x<b\}$, 其中,  $a \leq b$ 是实数. 我们定义区间 $I=[a,  b], [a,  b), (a,  b], (a,  b)$ 的长度 $|I|:=b-a$. 
